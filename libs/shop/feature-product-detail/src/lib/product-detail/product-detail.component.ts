...
@Component({
  ...
  imports: [CommonModule, CurrencyPipe, RouterLink, LoadingSpinnerComponent, ErrorMessageComponent],
  template: `
    <div class="product-detail-container">
      @if (loading()) {
      <shop-loading-spinner />
      } @else if (error()) {
      <shop-error-message [title]="'Product Not Found'" [message]="error() || undefined" (retry)="loadProduct()" />
      } @else if (product()) {
      ...
      <div class="product-detail">
        ...
        <div class="product-info-section">
          ...
          <div class="product-actions">
            ...
            <button class="btn-secondary" (click)="addToWishlist()">Add to Wishlist</button>
            } @else {
