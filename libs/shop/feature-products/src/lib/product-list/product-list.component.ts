...
import { ProductGridComponent, LoadingSpinnerComponent, ErrorMessageComponent } from '@org/shop/shared-ui';

@Component({
  selector: 'shop-product-list',
  imports: [CommonModule, FormsModule, ProductGridComponent, LoadingSpinnerComponent, ErrorMessageComponent],
  template: `
    <div class="product-list-container">
      ...
      <div class="filters-section">
        ...
        <div class="filter-controls">
          ...
          <label class="checkbox-label">
            <input type="checkbox" [(ngModel)]="inStockOnly" (ngModelChange)="onFilterChange()" />
            In Stock Only
          </label>
        </div>
      </div>
      ...
      <shop-error-message [message]="error() || undefined" (retry)="loadProducts()" />
      } @else {
      <div class="results-info">Showing {{ products().length }} of {{ totalProducts() }} products</div>

      <shop-product-grid [products]="products()" (productSelect)="onProductSelect($event)" />
